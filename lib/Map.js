...
function (_MapEvented) {
  ...
  _proto.updateLeafletElement = function updateLeafletElement(fromProps, toProps) {
    ...
    if (viewport && !(0, _fastDeepEqual.default)(viewport, fromProps.viewport)) {
    ...
    if (bounds && (this.shouldUpdateBounds(bounds, fromProps.bounds) || !(0, _fastDeepEqual.default)(boundsOptions, fromProps.boundsOptions))) {
      if (useFlyTo === true) {
    ...
    if (!(0, _fastDeepEqual.default)(boxZoom, fromProps.boxZoom)) {
      if (boxZoom === true) {
  ...
  _proto.shouldUpdateCenter = function shouldUpdateCenter(next, prev) {
    ...
    return !(0, _fastDeepEqual.default)(next[0], prev[0]) || !(0, _fastDeepEqual.default)(next[1], prev[1]);
  };
